 ...
 */
public final class EOIAgent implements Runnable, AutoCloseable {

    private static final Logger LOGGER = LogManager.getLogger(EOIAgent.class);
    ...
    public static void main(final String... args) {
        ...
        try (
                final EOIAgent logstash = new EOIAgent(home, args, System.out, System.err, System.in)
        ) {
            logstash.run();
     ...
     */
    EOIAgent(final Path home, final String[] args, final PrintStream output,
    ...
    private static RubyInstanceConfig buildConfig(final Path home, final String[] args) {
        ...
        arguments[1] = safePath(home, "core", "lib", "logstash", "runner.rb");
